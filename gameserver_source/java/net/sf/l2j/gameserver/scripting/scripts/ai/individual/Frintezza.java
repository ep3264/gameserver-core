...
public class Frintezza extends AbstractNpcAI
{
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		else if (event.equalsIgnoreCase("room1_spawn"))
		{
			...
			DoorTable.getInstance().getDoor(25150053).openMe();
		}
	...
	public String onAttack(L2Npc npc, L2PcInstance attacker, int damage, boolean isPet, L2Skill l2Skill)
	{
		...
		return super.onAttack(npc, attacker, damage, isPet, l2Skill);
	}
	...
	public String onKill(L2Npc npc, L2PcInstance killer, boolean isPet)
	{
		if (npc.getNpcId() == SCARLET2)
		{
			...
			startQuestTimer("stop_npc", 100, npc, null, false);
			startQuestTimer("morph_16", 200, npc, null, false);
