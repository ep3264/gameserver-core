...
public class GhostsShouts implements Runnable
{
	...
	private static final String[] dcText =
	{
	...
	private static final String[] dcNames =
	{
		// l2online_c4 (with priority dupl)
		"xxSMEGOLxx",
		"BadHabito",
		"MAFIOSI",
		"Kelt",
	...
	private static final int[] dcChat =
	{
		8,
		1
	};
	...
	public void run()
	{
		try
		{
			...
			if (player != null)
			{
				...
				{
					if (region == MapRegionTable.getMapRegion(pc.getX(), pc.getY()))
					{
						pc.sendPacket(cs);
					}
				}
	...
	{
		return dcNames[Rnd.get(dcNames.length)];
	}
	
	private static String getRandomText()
	{
		return dcText[Rnd.get(dcText.length)];
	}
	
	private static int getRandomChat()
	{
		return dcChat[Rnd.get(dcChat.length)];
	}
