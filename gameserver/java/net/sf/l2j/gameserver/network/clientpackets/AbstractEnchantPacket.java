...
public abstract class AbstractEnchantPacket extends L2GameClientPacket
{
	...
	static
	{
		...
		// 100% Redist Weapon
		_scrolls.put(9209, new EnchantScroll(true, false, true, CrystalType.S));
		// 100% Redist Armor
		_scrolls.put(9210, new EnchantScroll(false, false, true, CrystalType.S));
		_scrolls.put(9211, new EnchantScroll(false, false, true, CrystalType.A));
		_scrolls.put(9212, new EnchantScroll(false, false, true, CrystalType.B));
