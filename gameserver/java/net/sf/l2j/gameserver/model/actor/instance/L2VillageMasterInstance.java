		...
		else if (command.startsWith("Subclass"))
		{
			...
			switch (cmdChoice)
			{
				...
				case 2: // Change Class - Initial
					...
					{
						sb = new StringBuilder(300);
						//TODO : Redist class master
						if (!Config.CHECK_VILLAGE_MASTER ||(Config.CHECK_VILLAGE_MASTER && checkVillageMaster(player.getBaseClass())))
						...
						for (Iterator<SubClass> subList = player.getSubClasses().values().iterator(); subList.hasNext();)
						{
							...
							if (!Config.CHECK_VILLAGE_MASTER ||(Config.CHECK_VILLAGE_MASTER && checkVillageMaster(subClass.getClassDefinition())))
